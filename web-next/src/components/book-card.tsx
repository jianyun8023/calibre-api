    ...
    >
      <Card
        className={cn(
          ...
          // Light mode: Glass effect with glow border
          "glass glow-border",
          // Dark mode: Minimal clean design
          "dark:bg-card dark:border-border/40 card-minimal",
          // Hover effects
          "hover:shadow-aurora-lg hover:scale-[1.02]",
          "dark:hover:shadow-none dark:hover:scale-100"
        )}
        style={{
